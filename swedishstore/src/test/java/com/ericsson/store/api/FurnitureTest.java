...
public class FurnitureTest {
	...
	@Test(groups = "unit")
	public void The_beds_are_equal_when_all_fields_are_the_same() {
		final Size size = new Size(10, 10, 10);
		final TestA testA = new TestA("fancyName1", Room.Bedroom, Material.Metal, size, 100, "fieldA");
		final TestB testb = new TestB("fancyName1", Room.Bedroom, Material.Metal, size, 100, 42);
		final TestA testC = new TestA("fancyName2", Room.Bedroom, Material.Metal, size, 100, "fieldA");
